...
namespace Day_5_Inheritance_Example
{
    ...
    public class AmericanPlayingCard : PlayingCard  // Indicate PlayingCard is our base class
    {
     ...
     // (C# coding conventions: CONSTANT_NAMES - All uppercase; words separated by underscores)
        ...
        // Default Constructor for an AmericanPlayingCard - intialize default playing card
        
        //     it must call the base() to initialize the base class
        // The super class has only a 3-ar ctor so we have to call it to initialize the super class data
        // Creating an AmericanPlayingCard without adding any parameters
        ...
        {                                            // Actual card color will be set after suit is validated
            InitializeSuitColors(); //Call a method to set up our suit/color dictionary
