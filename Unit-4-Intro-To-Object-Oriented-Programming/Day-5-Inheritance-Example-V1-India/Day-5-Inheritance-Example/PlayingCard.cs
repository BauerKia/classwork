...
//  access type  name
    public class PlayingCard
    {
        ...
        // Following Ecapsulation is making these values private!
        // Traditional Ecapsulation will not use C# because they believe there should be no public access
        // Properties allow for your choice of adding some public access
        ...
        /*
         * If you dont want people seeing your data -> dont give a getter
         * If yo udont want people changing your data -> dont provide a setter
         */
        ...
        // If you want to compare the contents of the object - Need to create an Equals override
        
        // The keyword - this - represents the object used to invoke the method
        //
        //       In the class method:  this (represents the object left of the dot)
        ...
        public override bool Equals(object otherObject) //Note: the parameter is a generic object type
        {
            ...
            PlayingCard otherCard = (PlayingCard) otherObject; //Cast the generic to an object of the class and store it
