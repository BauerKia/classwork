...
public class PlayingCard
{
     ...
     ***************************************************************************************************/
// Java @Overide asks the compiler to verify the overirde is correct
    //  @override is optional in Java - good idea to code it tobe sure your override is correct

    // C#: override keyword in method signature: public override string ToString()
    //     override keword was required
    @Override
