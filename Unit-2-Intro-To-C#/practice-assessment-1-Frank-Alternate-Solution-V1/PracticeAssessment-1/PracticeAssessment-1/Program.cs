...
class Program
{
    ...
    static bool IsTheSame(int num1, int num2)
    {
        ...
        // 1. C# will evaluate the num1==num2
        // 2. return the result from step1

        //C# expression always return value that use however you need to
    ...
    */
    static string FindBuildingType(int num1)
    {
        ...
        //two formats of the case statements:
        ...
        //          the value in the switch variable is assigned to variable defined after case
        switch (num1) // check the value in num1
        {
            case int house when house <= 3 : // assign value to num1 to new int house then check house
            {
