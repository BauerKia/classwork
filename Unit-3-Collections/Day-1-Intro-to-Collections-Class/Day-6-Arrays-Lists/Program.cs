...
class Program
{
    static void Main(string[] args)
    {
       ...
       // int[] numbers = new int[3];  // numbers.Length=5; 4 is the largest allowable index
        ...
        // Since our lList starts off empty - we can't use .Count to control our loop
        //Instead use code the number of time to loop
        for (int i=0; i < 3;      i++)  // i = 0, 1, 2 inside loop and 3 when exit loop
        {
           ...
           //convert it to an int
             numbers.Add(int.Parse(Console.ReadLine()));     //Need to use a method instead of subscript                                         // convert it toan int
